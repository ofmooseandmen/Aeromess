...
spec =
    describe "parseSignificantPoint" $ do
        ...
        it "parses HADDY" $ parseSignificantPoint "HADDY" `shouldBe` mkCodedDesignator "HADDY"
        it "parses 46N078W" $ parseSignificantPoint "46N078W" `shouldBe` mkPosition 46.0 (-78.0)
        it "parses 46S078E" $ parseSignificantPoint "46S078E" `shouldBe` mkPosition (-46.0) 78.0
